...
import dev.luna5ama.glwrapper.IGL45
...
open class GL45LWJGL2(override val tempArr: Arr) : IGL45 {
    ...
    override fun glMapNamedBufferRangeUnsafe(buffer: Int, offset: Long, length: Long, access: Int): Long {
        return GL45.glMapNamedBufferRange(buffer, offset, length, access, null).address
    }
    ...
    override fun glClearNamedFramebufferfi(framebuffer: Int, buffer: Int, depth: Float, stencil: Int) {
