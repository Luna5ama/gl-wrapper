...
import dev.luna5ama.glwrapper.IGL11
...
open class GL11LWJGL2(override val tempArr: Arr) : IGL11 {
    ...
    private val glGetIntegerv = wrapBuffer(createBuffer().asIntBuffer(), 16)
    ...
    private val glGetFloatv = wrapBuffer(createBuffer().asFloatBuffer(), 16)
    ...
    private val glGetDoublev = wrapBuffer(createBuffer().asDoubleBuffer(), 16)
